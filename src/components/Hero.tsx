...
const Hero = () => {
  return (
    <section className="w-full bg-[url('/images/vague.png')] bg-no-repeat bg-cover bg-bottom">
      <div className="max-w-6xl md:px-4 min-h-[667px] flex justify-center items-end mx-auto">
        <div className="bg-bluePrimary rounded-t-full md:rounded-full p-5 w-auto flex w-[522px] md:h-[522px] max-w-full flex-col items-center text-center relative">
          ...
          />
          <div className="flex mb-5 md:mb-20 items-start mt-3 max-0%]">
